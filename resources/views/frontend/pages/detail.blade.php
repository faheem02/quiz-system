        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-5">
                    ...
                    <img class="img-fluid rounded w-100 mb-4" src="{{ asset('img/header.jpg') }}" alt="Image">
                    ...
                    <p>Sadipscing labore amet rebum est et justo gubergren. Et eirmod ipsum sit diam ut magna lorem...</p>
                </div>

                <h2 class="mb-3">Related Courses</h2>
                <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                    @for ($i = 1; $i <= 3; $i++)
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="{{ route('pages.detail') }}">
                        <img class="img-fluid" src="{{ asset('img/courses-'.$i.'.jpg') }}" alt="">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <div class="mb-5">
                    ...
                    @for($i = 1; $i <= 4; $i++)
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="{{ route('pages.detail') }}">
